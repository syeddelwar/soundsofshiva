...
const Banner = () => {
  ...
  return (
    <>
      <div
        className="h-[90vh] bg-center bg-no-repeat bg-cover w-full relative"  
      ...
      >
        ...
        <div className="absolute z-40 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          <h2 data-aos="fade-down" className="text-white text-7xl text-center mt-6 font-bold">Sounds of Shiva </h2>
         ...
         <a href ="https://soundsofshiva.eventsmart.com/events/chapter-one-peumayen-nompuehuenu/" >  <button className="rounded-xl font-bold text-white bg-yellow px-8 py-3 mt-3">Book Now</button> </a>
         </div>
        </div>
